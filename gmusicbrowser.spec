...
Requires: perl >= 5.10, gtk2 >= 2.6.0, perl-Gtk2, perl(Locale::Messages), perl-GStreamer, perl-Digest-CRC, perl-Cairo, perl-HTML-Parser perl-IO-Compress, perl-Net-DBus
