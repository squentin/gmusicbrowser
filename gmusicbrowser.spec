...
Requires(hint): mpg123, vorbis-tools, alsa-utils, perl-Gtk2-WebKit, perl-Gtk2-MozEmbed, perl-Net-DBus, perl-Net-DBus-GLib, gstreamer0.10-lame, gstreamer0.10-plugins-ugly, gstreamer0.10-plugins-bad, perl-Digest-CRC, perl-Cairo, perl-Gnome2-Wnck, perl-GStreamer-Interfaces, perl-Gtk2-Notify, perl-HTML-Parser
AutoReq: no
AutoProv: no
