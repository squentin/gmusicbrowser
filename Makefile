...
install: all
	...
	install -pDm 644 org.gmusicbrowser.gmusicbrowser.appdata.xml "$(datadir)/appdata/org.gmusicbrowser.gmusicbrowser.appdata.xml"
...
uninstall:
	...
	rm -f "$(appdir)/gmusicbrowser.desktop" "$(datadir)/appdata/org.gmusicbrowser.gmusicbrowser.appdata.xml"
