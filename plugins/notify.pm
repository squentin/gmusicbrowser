...
{	my $vbox=Gtk2::VBox->new(::FALSE, 2);
	...
	my $entry1=::NewPrefEntry(OPT.'title',_"Title :",undef,$sg1,$sg2,undef,$replacetext);
	my $entry2=::NewPrefEntry(OPT.'text',_"Text :",undef,$sg1,$sg2,undef, $replacetext."\n\n"._("You can use some markup, eg : <b>bold</b>"));
...
{	return unless defined $::SongID && $::TogPlay;
	...
	my $pixbuf;
	my $file=$::Album{ $::Songs[$ID][::SONG_ALBUM] }[::AAPIXLIST];
	$pixbuf=::PixBufFromFile($file,$size) if $file && $size;
