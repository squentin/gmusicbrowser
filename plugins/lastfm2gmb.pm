...
{	my $vbox=Gtk2::VBox->new(0,2);
	...
	$description->set_markup(_"The plugin is based on the Program <b>lastfm2gmb</b> by Sergiy Borodych and is hosted on <a href='http://gmusicbrowser.org/dokuwiki/'>lastfm2gmb - GitHub</a>.");
